<template>
  <header class="p-10 shadow-sm">
    <h3 class="text-4xl font-semibold tracking-tight text-white">
      <i class="fa-regular fa-rectangle-list mr-5"></i>Mes Post-Its
    </h3>
  ...
  <div class="grid lg:grid-cols-2 xl:grid-cols-3 w-full gap-8">
    ...
    >
      ...
      <div class="opacity-0 group-hover:opacity-100">
        <div
          class="text-[16px] px-5 border-gray-700 space-x-3 text-gray-900 flex text-white-600 transition-all 5s"
        >
          <!-- <button
