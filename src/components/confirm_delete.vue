          ...
          <div class="bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
              ...
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h3 id="dialog-title" class="text-base font-semibold text-white">delete post it</h3>
                <div class="mt-2">
                  <p class="text-sm text-gray-400">
                    Are you sure you want to delete a post it? All of your data will be permanently
